        ...
        loga.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                    ...
                    Connection con= DriverManager.getConnection("jdbc:mysql://localhost:3306/dheerajdb", "user1", "123456");
                    Statement stmt = con.createStatement();
                    System.out.println("connetion created");

                    String sql="select email,password from employee where email="+'"'+"drnitharwal"+'"'+"and password="
                            +'"'+"123456"+'"'+';';
        ...
        nloga.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                try {
                  ...
                  */
                    String sql="INSERT into employee(name,post, address,mobilen,email,password) VALUES("+'"'+ncnamef.getText()+'"'+","+'"'+ncpostf.getText()+'"'+ ","+'"'+ncaddressf.getText()+'"'+
                            ","+'"'+ncmobf.getText()+'"'+","+'"'+ncemf.getText()+'"'+ ","+'"'+ncpf.getText()+'"'+");";
                    System.out.println(sql);
                    //    VALUES ('"+Text1+"','"+Text2+"')"
                    stmt.executeUpdate(sql);
                    i++;jl.setText("you are sucessfully registered");
